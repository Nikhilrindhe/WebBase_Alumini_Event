...
public class UpdateAlumniFromCollegeController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<form class='formarea' name='frm' action='finalupdatealumni' method='Post'>");
		
		out.println("<input type='hidden' name='oId' value='"+aId+"' class='control'/><br><br>");
