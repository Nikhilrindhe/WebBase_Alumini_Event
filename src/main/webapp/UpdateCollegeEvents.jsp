...
<%--  <p>Organizer id:<%=organizerid %></p>  --%>
                    ...
                    %>        
                        <h1 class="fw-bold fs-4 mb-3"  style="text-align: center;">Update Event for <%=CollegeName%> College</h1>
                        <div class="row">
                            <div class="col-12">
                               
                <br/><br/>                 
  <form class="formarea" name="frm" action="updateevent" method="post" style="text-align: center;">
